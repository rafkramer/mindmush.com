import { s as sanitize_props, a as spread_props, b as slot, d as attr_class, j as clsx } from "./index2.js";
...
function StateBadge($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const states = {
      ...
      scaling: "bg-indigo-500/15 text-indigo-400",
      passive: "bg-amber-500/12 text-amber-400",
      killed: "bg-red-500/12 text-red-400"
    };
    const labels = {
      building: "Building",
      live: "Live",
    ...
    $$renderer2.push(`<span${attr_class(clsx(cn("inline-flex items-center px-3 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider", states[state], className)))}>${escape_html(labels[state])}</span>`);
  });
}
export {
  Gamepad_2 as G,
